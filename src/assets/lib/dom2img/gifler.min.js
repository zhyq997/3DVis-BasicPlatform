                  ...
                  null == this.onFrame &&
                    (this.onFrame = (function (n) {
                      return function (i, o) {
                        ...
                        switch (
                          (null == i.buffer &&
                            (i.buffer = t.createBufferCanvas(i, n.width, n.height)),
                  ...
                  function (e, n, r) {
                    ...
                    (i.prototype.disableTrampolineIfNecessary = function () {
                      ...
                      (i.prototype.fatalError = function (e, n) {
                        n
                          ? (t.stderr.write('Fatal ' + (e instanceof Error ? e.stack : e)),
                            t.exit(2))
                          : this.throwLater(e);
                      }),
                    ...
                    e.exports = function (e) {
                      function n(t, n) {
                        ...
                        if ((null != t && (r = t[n]), 'function' != typeof r)) {
                          var i =
                            'Object ' + a.classString(t) + " has no method '" + a.toString(n) + "'";
                    ...
                    e.exports = function (t) {
                      ...
                      return (
                        ...
                        (e.prototype._pushContext = function () {
                          void 0 !== this._trace &&
                            ((this._trace._promisesCreated = 0), o.push(this._trace));
                        }),
                  ...
                  function (e, n, r) {
                    ...
                    n.exports = function (n, r) {
                      ...
                      function C(t) {
                        ...
                        return (
                          (e =
                            'string' == typeof e && e.length > 0 ? w(t) : ['    (No stack trace)']),
                          { message: n, stack: b(e) }
                        );
                      }
                      function j(t, e, n) {
                      ...
                      H.inherits(R, Error),
                        ...
                        (R.prototype.attachExtraTrace = function (t) {
                          if (!t.__stackCleaned__) {
                            this.uncycle();
                            for (
                              var e = C(t), n = e.message, r = [e.stack], i = this;
                              void 0 !== i;
                          ...
                          return (
                            ...
                            function (t, e, n) {
                              var r = o[t],
                                i = self[r];
                              return i
                                ? ('rejectionHandled' === t ? i.call(self, n) : i.call(self, e, n),
                                  !0)
                                : !1;
                            }
                          );
                    ...
                    e.exports = function (e, n) {
                      ...
                      function a(t) {
                        ...
                        if (!this.called) {
                          this.called = !0;
                          var h =
                            0 === this.type ? u.call(a._boundValue()) : u.call(a._boundValue(), t);
                          if (void 0 !== h) {
                            var f = n(h, a);
                            if (f instanceof e) {
                ...
                22: [
                  function (e, n, r) {
                    ...
                    n.exports = function () {
                      ...
                      function r(t, e) {
                        if ('function' != typeof e)
                          throw new m('expecting a function but got ' + p.classString(e));
                        if (t.constructor !== i)
                          throw new m(
                      ...
                      return (
                          ...
                          function (t) {
                            ...
                            if (e > 1) {
                              ...
                              for (n = 0; e - 1 > n; ++n) {
                                var o = arguments[n];
                                if (!p.isObject(o))
                                  return h('expecting an object but got ' + p.classString(o));
                                r[i++] = o;
                              }
                              return (
                                (r.length = i), (t = arguments[n]), this.then(void 0, P(r, t, this))
                              );
                            }
                        ...
                        (i.prototype.then = function (t, e) {
                          if (
                            ...
                            var n =
                              '.then() only accepts functions but was passed: ' + p.classString(t);
                        ...
                        (i.cast = function (t) {
                          ...
                          return (
                            e instanceof i ||
                              ((e = new i(b)), e._setFulfilled(), (e._rejectionHandler0 = t)),
                            e
                          );
                        }),
                        ...
                        (i.setScheduler = function (t) {
                          if ('function' != typeof t)
                            throw new m('expecting a function but got ' + p.classString(t));
                          var e = v._schedule;
                  ...
                  function (t, e, n) {
                    ...
                    e.exports = function (e, n) {
                      ...
                      function c(t, e, n, r, i) {
                        for (
                          var o = new RegExp(F(e) + '$'), s = a(t, e, o, n), u = 0, c = s.length;
                          c > u;
                          u += 2
                        ) {
                          var l = s[u],
                    ...
                    e.exports = function (e, n, r, i) {
                      function o(t, o) {
                        ...
                        if (((t = s.asArray(t)), null === t))
                          return i(
                            'expecting an array or an iterable object but got ' + s.classString(t),
                          );
                        var c = new e(n);
                ...
                28: [
                  function (t, e, n) {
                    ...
                    e.exports = function (e, n, r, i, o, s) {
                      ...
                      function c(t, e, n, i) {
                        if ('function' != typeof e)
                          return r('expecting a function but got ' + p.classString(e));
                        var o = new a(t, e, n, i);
                        return o.promise();
                      }
                      function l(t) {
                  ...
                  function (t, e, n) {
                    ...
                    e.exports = function (e, n) {
                      ...
                      function a(t, r, i) {
                        ...
                        return (
                          (h = !1), a && f === c && (a._rejectCallback(f.e, !0), (a = null)), l
                        );
                      }
                      var u = t('./util'),
                        c = u.errorObj,
                        ...
                        (e.using = function () {
                          ...
                          for (var u = new p(t), h = 0; t > h; ++h) {
                            ...
                            if (l.isDisposer(d)) {
                              ...
                              var g = r(d);
                              g instanceof e &&
                                (d = g._then(f, null, null, { resources: u, index: h }, void 0));
                            }
                            u[h] = d;
                          }
        ...
        function s(t, e, n, r) {
          for (
            ...
            if (((h >>= u), (l -= u), v !== o)) {
              ...
              null !== d &&
                4096 > a &&
                ((_[a++] = (d << 8) | b), a >= c + 1 && 12 > u && (++u, (c = (c << 1) | 1))),
                (d = v);
