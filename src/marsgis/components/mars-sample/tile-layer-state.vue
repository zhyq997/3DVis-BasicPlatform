<template>
  ...
  <div class="layer-control">
    <a-space>
      ...
      <mars-button type="primary" danger v-if="formState.hasAddTileLayer" @click="removeTileLayer"
        >移除图层</mars-button
      >
    </a-space>
  </div>
    ...
    <div class="bottom-box">
      ...
      <div class="f-mb f-pt">
        <a-space>
          ...
          <a-checkbox v-model:checked="formState.show" @change="onChangeShow" title="显示隐藏状态"
            >显示</a-checkbox
          >
        </a-space>
      </div>
      ...
      <div class="f-mb" v-if="props.interaction">
        <a-space>
          ...
          <a-checkbox
            v-model:checked="formState.hasPopup"
            @change="onChangePopup"
            title="是否绑定Popup鼠标单击弹窗"
            >单击Popup</a-checkbox
          >
          <a-checkbox
            v-model:checked="formState.hasHighlight"
            @change="onChangeHighlight"
            title="是否绑定单击高亮其对应矢量数据"
            >单击高亮</a-checkbox
          >
        </a-space>
      </div>
