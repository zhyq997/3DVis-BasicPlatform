    ...
    <div class="query-poi" @mousedown="clickVoid">
      <div class="query-poi__search">
        <mars-input
          ...
          @pressEnter="selectPoint(searchTxt)"
        ></mars-input>
      ...
      <ul class="search-list" v-if="searchListShow">
        ...
        <p v-if="isShowClearHisBtn" class="search-list__clear" @click="clearHistoryList"
          >删除历史</p
        >
      </ul>
      ...
      <div class="query-site" v-if="siteListShow">
        <template v-if="siteSource && siteSource.length">
          <ul>
            <li
              v-for="(item, i) in siteSource"
              :key="i"
              class="query-site__item"
          ...
          <div class="query-site__page">
            ...
            <a-pagination
              @change="(page: number) => querySiteList(searchTxt, page)"
              size="small"
              :total="allCount"
              pageSize="6"
              :simple="true"
