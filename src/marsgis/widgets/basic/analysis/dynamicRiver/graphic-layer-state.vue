<template>
  <div class="f-mb">
    ...
    <div>
      <mars-button @click="mapWork.addRiver()" title="视角定位" size="small"> 5年一遇 </mars-button>
      <mars-button @click="mapWork.addDemoGraphic1(10)" title="视角定位" size="small">
        10年一遇
      </mars-button>
      <mars-button @click="mapWork.addDemoGraphic1(20)" title="视角定位" size="small">
        20年一遇
      </mars-button>
      <mars-button @click="mapWork.addDemoGraphic1(50)" title="视角定位" size="small">
        50年一遇
      </mars-button>
      <mars-button @click="mapWork.addDemoGraphic1(100)" title="视角定位" size="small">
        100年一遇
      </mars-button>
      <mars-button @click="mapWork.addDemoGraphic1(1000)" title="视角定位" size="small">
        1000年一遇
      </mars-button>
      <mars-button @click="mapWork.addDemoGraphic1(0)" title="视角定位" size="small">
        溃坝洪水
      </mars-button>
      <!-- <mars-button @click="mapWork.addDemoGraphic3()" title="视角定位" size="small">
        开始3
      </mars-button> -->
    </div>
  </div>
