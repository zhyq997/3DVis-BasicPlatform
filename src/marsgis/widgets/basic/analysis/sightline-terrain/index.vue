  ...
  <mars-dialog :visible="true" right="10" top="10">
    <div class="f-mb">
      <a-space>
        ...
        <mars-slider @change="headingChange" v-model:value="modelParams.heading" :min="0" :max="360" :step="0.01" />值{{
          modelParams.heading }}
      </a-space>
    </div>
    ...
    <div class="f-mb">
      <a-space>
        ...
        <mars-slider @change="pitchChange" v-model:value="modelParams.pitch" :min="-180" :max="180" :step="0.01" />值{{
          modelParams.pitch }}
      </a-space>
    </div>
    ...
    <div class="f-mb">
      <a-space>
        ...
        <mars-slider @change="rollChange" v-model:value="modelParams.roll" :min="-180" :max="180" :step="0.01" />值{{
          modelParams.roll }}
      </a-space>
    </div>
